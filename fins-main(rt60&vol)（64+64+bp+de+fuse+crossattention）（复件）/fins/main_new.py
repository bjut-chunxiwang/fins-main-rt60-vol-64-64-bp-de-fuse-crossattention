...
def main(args):
    # load config
    config_path = "/home/cxw/GAN/fins-main(rt60&vol)（64+64+bp+de+fuse+crossattention）/fins/config.yaml"
    ...
    csv_path = ("/home/cxw/GAN/fins-main(rt60&vol)（64+64+bp+de+fuse+crossattention）/fins/read(BP).csv")  # CSV 文件路径
