...
class Encoder(nn.Module):
    ...
    def forward(self, x, vector_32d):
        ...
        attention_output_z_to_v = self.crossA2V(src=z, tar=vector_32d_expanded)  # z -> vector_32d_expanded
        attention_output_v_to_z = self.crossV2A(src=vector_32d_expanded, tar=z)  # vector_32d_expanded -> z
        z = torch.cat([attention_output_z_to_v, attention_output_v_to_z],dim=-1)  # 形状为 (batch_size, 256)
        return z
